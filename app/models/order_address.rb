class OrderAddress
  ...
  attr_accessor :postal_code, :prefecture_id, :city, :house_number, :building_name, :tel_number, :user_id, :item_id, :address_id, :token
  ...
  def save
    order = Order.create(user_id: user_id, item_id: item_id, address_id: address_id)
